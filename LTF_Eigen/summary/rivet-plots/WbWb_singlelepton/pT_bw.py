...
# Analysis object: /WbWb_singlelepton/pT_bw
...
exec(open(prefix+'pT_bw__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'pT_bw.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'pT_bw.png'), format='PNG')
