...
# Analysis object: /WbWb_singlelepton/m_bl_pT_whad
...
dataf = dict()
exec(open(os.path.split(__file__)[0] + '/m_bl_pT_whad__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'm_bl_pT_whad.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'm_bl_pT_whad.png'), format='PNG')
