...
# Analysis object: /WbWb_singlelepton/dr_bl
...
exec(open(prefix+'dr_bl__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'dr_bl.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'dr_bl.png'), format='PNG')
