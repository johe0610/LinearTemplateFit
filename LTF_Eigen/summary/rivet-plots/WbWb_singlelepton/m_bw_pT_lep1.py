...
# Analysis object: /WbWb_singlelepton/m_bw_pT_lep1
...
dataf = dict()
exec(open(os.path.split(__file__)[0] + '/m_bw_pT_lep1__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'm_bw_pT_lep1.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'm_bw_pT_lep1.png'), format='PNG')
