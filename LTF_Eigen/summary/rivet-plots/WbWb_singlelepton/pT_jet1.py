...
# Analysis object: /WbWb_singlelepton/pT_jet1
...
exec(open(prefix+'pT_jet1__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'pT_jet1.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'pT_jet1.png'), format='PNG')
