...
# Analysis object: /WbWb_singlelepton/pT_jet2
...
exec(open(prefix+'pT_jet2__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'pT_jet2.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'pT_jet2.png'), format='PNG')
