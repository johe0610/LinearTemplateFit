...
# Analysis object: /WbWb_singlelepton/m_bl_fine
...
exec(open(prefix+'m_bl_fine__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'm_bl_fine.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'm_bl_fine.png'), format='PNG')
