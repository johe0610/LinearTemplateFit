...
# Analysis object: /WbWb_singlelepton/dr_bl_pT_whad
...
dataf = dict()
exec(open(os.path.split(__file__)[0] + '/dr_bl_pT_whad__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'dr_bl_pT_whad.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'dr_bl_pT_whad.png'), format='PNG')
