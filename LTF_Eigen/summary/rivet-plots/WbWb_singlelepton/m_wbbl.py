...
# Analysis object: /WbWb_singlelepton/m_wbbl
...
exec(open(prefix+'m_wbbl__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'm_wbbl.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'm_wbbl.png'), format='PNG')
