...
# Analysis object: /WbWb_singlelepton/dr_bw
...
exec(open(prefix+'dr_bw__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'dr_bw.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'dr_bw.png'), format='PNG')
