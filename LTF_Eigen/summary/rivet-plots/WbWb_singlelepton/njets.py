...
# Analysis object: /WbWb_singlelepton/njets
...
exec(open(prefix+'njets__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'njets.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'njets.png'), format='PNG')
