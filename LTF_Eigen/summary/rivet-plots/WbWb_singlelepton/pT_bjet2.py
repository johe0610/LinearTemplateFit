...
# Analysis object: /WbWb_singlelepton/pT_bjet2
...
exec(open(prefix+'pT_bjet2__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'pT_bjet2.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'pT_bjet2.png'), format='PNG')
