...
# Analysis object: /WbWb_singlelepton/pT_whad
...
exec(open(prefix+'pT_whad__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'pT_whad.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'pT_whad.png'), format='PNG')
