...
# Analysis object: /WbWb_singlelepton/m_bw_dr_bl
...
dataf = dict()
exec(open(os.path.split(__file__)[0] + '/m_bw_dr_bl__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'm_bw_dr_bl.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'm_bw_dr_bl.png'), format='PNG')
