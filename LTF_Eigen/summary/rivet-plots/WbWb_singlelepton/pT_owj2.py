...
# Analysis object: /WbWb_singlelepton/pT_owj2
...
exec(open(prefix+'pT_owj2__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'pT_owj2.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'pT_owj2.png'), format='PNG')
