...
# Analysis object: /WbWb_singlelepton/pT_bl
...
exec(open(prefix+'pT_bl__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'pT_bl.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'pT_bl.png'), format='PNG')
