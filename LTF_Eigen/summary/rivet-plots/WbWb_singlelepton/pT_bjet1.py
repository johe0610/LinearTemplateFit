...
# Analysis object: /WbWb_singlelepton/pT_bjet1
...
exec(open(prefix+'pT_bjet1__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'pT_bjet1.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'pT_bjet1.png'), format='PNG')
