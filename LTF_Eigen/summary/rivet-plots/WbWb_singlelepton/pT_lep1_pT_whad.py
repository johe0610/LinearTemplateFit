...
# Analysis object: /WbWb_singlelepton/pT_lep1_pT_whad
...
labels = [ r"WbWb\_Slurm\_Template\_171" ]
...
dataf = dict()
exec(open(os.path.split(__file__)[0] + '/pT_lep1_pT_whad__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'pT_lep1_pT_whad.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'pT_lep1_pT_whad.png'), format='PNG')
