...
# Analysis object: /WbWb_singlelepton/m_bw_fine
...
exec(open(prefix+'m_bw_fine__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'm_bw_fine.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'm_bw_fine.png'), format='PNG')
