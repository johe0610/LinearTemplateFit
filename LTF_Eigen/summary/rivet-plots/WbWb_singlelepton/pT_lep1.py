...
# Analysis object: /WbWb_singlelepton/pT_lep1
...
exec(open(prefix+'pT_lep1__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'pT_lep1.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'pT_lep1.png'), format='PNG')
