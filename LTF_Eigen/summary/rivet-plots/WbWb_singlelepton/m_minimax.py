...
# Analysis object: /WbWb_singlelepton/m_minimax
...
exec(open(prefix+'m_minimax__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'm_minimax.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'm_minimax.png'), format='PNG')
