...
# Analysis object: /WbWb_singlelepton/cutflow
# Timestamp: 12-01-2026 (12:51:17)
...
exec(open(prefix+'cutflow__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'cutflow.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'cutflow.png'), format='PNG')
