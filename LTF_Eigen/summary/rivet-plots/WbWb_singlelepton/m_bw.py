...
# Analysis object: /WbWb_singlelepton/m_bw
...
exec(open(prefix+'m_bw__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'm_bw.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'm_bw.png'), format='PNG')
