...
# Analysis object: /WbWb_singlelepton/y_whad
...
exec(open(prefix+'y_whad__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'y_whad.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'y_whad.png'), format='PNG')
