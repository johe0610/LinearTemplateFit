...
# Analysis object: /WbWb_singlelepton/pT_owj1
# Timestamp: 12-01-2026 (12:51:19)
...
exec(open(prefix+'pT_owj1__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'pT_owj1.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'pT_owj1.png'), format='PNG')
