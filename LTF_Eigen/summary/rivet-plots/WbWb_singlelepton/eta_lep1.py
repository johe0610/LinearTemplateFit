...
# Analysis object: /WbWb_singlelepton/eta_lep1
...
exec(open(prefix+'eta_lep1__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'eta_lep1.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'eta_lep1.png'), format='PNG')
