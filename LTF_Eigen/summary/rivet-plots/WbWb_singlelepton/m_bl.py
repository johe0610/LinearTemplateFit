...
# Analysis object: /WbWb_singlelepton/m_bl
...
exec(open(prefix+'m_bl__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'm_bl.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'm_bl.png'), format='PNG')
