...
# Analysis object: /WbWb_singlelepton/mT_lep1met
# Timestamp: 12-01-2026 (12:51:18)
...
labels = {
    'legend' : ([ r"WbWb\_Slurm\_Template\_171", r"WbWb\_Slurm\_Template\_162\_5", r"WbWb\_Slurm\_Template\_165", r"WbWb\_Slurm\_Template\_167\_5", r"WbWb\_Slurm\_Template\_170", r"WbWb\_Slurm\_Template\_172\_5", r"WbWb\_Slurm\_Template\_175", r"WbWb\_Slurm\_Template\_177\_5", r"WbWb\_Slurm\_Template\_180", r"WbWb\_Slurm\_Template\_182\_5" ], r""),
}
...
exec(open(prefix+'mT_lep1met__data.py').read(), dataf)
...
for label, yvals in dataf['ratio0_yvals'].items():
    ...
    if styles[label]['ratio0_histstyle']: # plot as histogram
        xpos = dataf['xedges']['WbWb_LO_PS_Had_171/Analysis/WbWb_Slurm_Template_171.yoda.gz'] if styles[label]['ratio0_drawstyle'] else dataf['xpoints']['WbWb_LO_PS_Had_171/Analysis/WbWb_Slurm_Template_171.yoda.gz']
    ...
    tmp = ratio0_ax.errorbar(dataf['xpoints']['WbWb_LO_PS_Had_171/Analysis/WbWb_Slurm_Template_171.yoda.gz'], yvals,
    ...
    for varlabel in dataf['ratio0_variation_vals'].keys():
        if varlabel.startswith(label):
            ratio0_ax.plot(dataf['xedges']['WbWb_LO_PS_Had_171/Analysis/WbWb_Slurm_Template_171.yoda.gz'],
...
plt.savefig(os.path.join(plot_outdir, 'mT_lep1met.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'mT_lep1met.png'), format='PNG')
