...
# Analysis object: /WbWb_dilepton/mT_bb4l
...
exec(open(prefix+'mT_bb4l__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'mT_bb4l.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'mT_bb4l.png'), format='PNG')
