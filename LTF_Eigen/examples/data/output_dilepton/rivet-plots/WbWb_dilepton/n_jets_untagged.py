...
# Analysis object: /WbWb_dilepton/n_jets_untagged
...
exec(open(prefix+'n_jets_untagged__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'n_jets_untagged.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'n_jets_untagged.png'), format='PNG')
