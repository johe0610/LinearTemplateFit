...
# Analysis object: /WbWb_dilepton/el_e_presel
...
exec(open(prefix+'el_e_presel__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'el_e_presel.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'el_e_presel.png'), format='PNG')
