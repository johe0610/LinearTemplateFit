...
# Analysis object: /WbWb_dilepton/yield_inclusive
...
exec(open(prefix+'yield_inclusive__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'yield_inclusive.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'yield_inclusive.png'), format='PNG')
