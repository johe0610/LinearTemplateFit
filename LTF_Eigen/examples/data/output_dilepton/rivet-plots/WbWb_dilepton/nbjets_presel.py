...
# Analysis object: /WbWb_dilepton/nbjets_presel
...
exec(open(prefix+'nbjets_presel__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'nbjets_presel.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'nbjets_presel.png'), format='PNG')
