...
# Analysis object: /WbWb_dilepton/n_jets
...
exec(open(prefix+'n_jets__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'n_jets.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'n_jets.png'), format='PNG')
