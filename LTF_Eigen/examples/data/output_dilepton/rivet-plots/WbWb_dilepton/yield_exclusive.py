...
# Analysis object: /WbWb_dilepton/yield_exclusive
...
exec(open(prefix+'yield_exclusive__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'yield_exclusive.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'yield_exclusive.png'), format='PNG')
