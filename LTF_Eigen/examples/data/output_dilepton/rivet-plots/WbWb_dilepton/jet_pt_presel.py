...
# Analysis object: /WbWb_dilepton/jet_pt_presel
...
exec(open(prefix+'jet_pt_presel__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'jet_pt_presel.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'jet_pt_presel.png'), format='PNG')
