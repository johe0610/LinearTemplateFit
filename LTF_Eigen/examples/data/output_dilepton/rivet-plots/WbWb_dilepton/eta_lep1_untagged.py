...
# Analysis object: /WbWb_dilepton/eta_lep1_untagged
...
exec(open(prefix+'eta_lep1_untagged__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'eta_lep1_untagged.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'eta_lep1_untagged.png'), format='PNG')
