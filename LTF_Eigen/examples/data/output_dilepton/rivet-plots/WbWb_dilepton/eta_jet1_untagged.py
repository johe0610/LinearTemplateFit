...
# Analysis object: /WbWb_dilepton/eta_jet1_untagged
...
exec(open(prefix+'eta_jet1_untagged__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'eta_jet1_untagged.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'eta_jet1_untagged.png'), format='PNG')
