...
# Analysis object: /WbWb_dilepton/nel_presel
...
exec(open(prefix+'nel_presel__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'nel_presel.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'nel_presel.png'), format='PNG')
