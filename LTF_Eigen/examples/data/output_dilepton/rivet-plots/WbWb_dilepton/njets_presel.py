...
# Analysis object: /WbWb_dilepton/njets_presel
...
exec(open(prefix+'njets_presel__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'njets_presel.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'njets_presel.png'), format='PNG')
