...
# Analysis object: /WbWb_dilepton/n_bjets_untagged
...
exec(open(prefix+'n_bjets_untagged__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'n_bjets_untagged.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'n_bjets_untagged.png'), format='PNG')
