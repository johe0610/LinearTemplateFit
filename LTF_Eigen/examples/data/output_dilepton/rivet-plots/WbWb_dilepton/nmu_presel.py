...
# Analysis object: /WbWb_dilepton/nmu_presel
...
exec(open(prefix+'nmu_presel__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'nmu_presel.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'nmu_presel.png'), format='PNG')
