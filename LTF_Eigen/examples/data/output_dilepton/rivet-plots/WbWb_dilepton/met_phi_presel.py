...
# Analysis object: /WbWb_dilepton/met_phi_presel
...
exec(open(prefix+'met_phi_presel__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'met_phi_presel.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'met_phi_presel.png'), format='PNG')
