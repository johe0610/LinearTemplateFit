...
# Analysis object: /WbWb_dilepton/pT_lep2
...
exec(open(prefix+'pT_lep2__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'pT_lep2.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'pT_lep2.png'), format='PNG')
