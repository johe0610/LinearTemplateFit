...
# Analysis object: /WbWb_dilepton/nleps_presel
...
exec(open(prefix+'nleps_presel__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'nleps_presel.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'nleps_presel.png'), format='PNG')
