...
# Analysis object: /WbWb_dilepton/pT_b1b2
...
exec(open(prefix+'pT_b1b2__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'pT_b1b2.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'pT_b1b2.png'), format='PNG')
