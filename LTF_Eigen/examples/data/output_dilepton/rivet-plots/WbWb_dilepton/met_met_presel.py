...
# Analysis object: /WbWb_dilepton/met_met_presel
...
exec(open(prefix+'met_met_presel__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'met_met_presel.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'met_met_presel.png'), format='PNG')
