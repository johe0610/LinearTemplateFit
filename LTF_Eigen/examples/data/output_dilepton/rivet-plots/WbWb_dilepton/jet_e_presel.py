...
# Analysis object: /WbWb_dilepton/jet_e_presel
...
ax_yScale = 'log'
xLims = (0.0, 200.0)
yLims = (0.0009000000000000001, 0.011000000000000001)
...
exec(open(prefix+'jet_e_presel__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'jet_e_presel.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'jet_e_presel.png'), format='PNG')
