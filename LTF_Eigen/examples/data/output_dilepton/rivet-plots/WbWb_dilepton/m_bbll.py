...
# Analysis object: /WbWb_dilepton/m_bbll
...
exec(open(prefix+'m_bbll__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'm_bbll.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'm_bbll.png'), format='PNG')
