...
# Analysis object: /WbWb_dilepton/jet_eta_presel
...
exec(open(prefix+'jet_eta_presel__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'jet_eta_presel.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'jet_eta_presel.png'), format='PNG')
