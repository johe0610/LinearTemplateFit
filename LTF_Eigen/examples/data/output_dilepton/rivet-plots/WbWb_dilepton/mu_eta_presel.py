...
# Analysis object: /WbWb_dilepton/mu_eta_presel
...
exec(open(prefix+'mu_eta_presel__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'mu_eta_presel.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'mu_eta_presel.png'), format='PNG')
