...
# Analysis object: /WbWb_dilepton/eta_jet2_untagged
...
exec(open(prefix+'eta_jet2_untagged__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'eta_jet2_untagged.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'eta_jet2_untagged.png'), format='PNG')
