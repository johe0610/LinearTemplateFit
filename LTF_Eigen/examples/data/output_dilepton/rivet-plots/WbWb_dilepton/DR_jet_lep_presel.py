...
# Analysis object: /WbWb_dilepton/DR_jet_lep_presel
...
exec(open(prefix+'DR_jet_lep_presel__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'DR_jet_lep_presel.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'DR_jet_lep_presel.png'), format='PNG')
