...
# Analysis object: /WbWb_dilepton/phi_lep2_untagged
...
exec(open(prefix+'phi_lep2_untagged__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'phi_lep2_untagged.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'phi_lep2_untagged.png'), format='PNG')
