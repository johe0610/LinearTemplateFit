...
# Analysis object: /WbWb_dilepton/el_pt_presel
...
exec(open(prefix+'el_pt_presel__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'el_pt_presel.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'el_pt_presel.png'), format='PNG')
