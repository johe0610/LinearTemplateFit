...
# Analysis object: /WbWb_dilepton/pT_lep2_untagged
...
exec(open(prefix+'pT_lep2_untagged__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'pT_lep2_untagged.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'pT_lep2_untagged.png'), format='PNG')
