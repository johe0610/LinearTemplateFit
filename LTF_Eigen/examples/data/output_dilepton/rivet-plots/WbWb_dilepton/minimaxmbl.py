...
# Analysis object: /WbWb_dilepton/minimaxmbl
...
exec(open(prefix+'minimaxmbl__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'minimaxmbl.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'minimaxmbl.png'), format='PNG')
