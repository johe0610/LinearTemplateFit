...
# Analysis object: /WbWb_dilepton/eta_lep2_untagged
...
exec(open(prefix+'eta_lep2_untagged__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'eta_lep2_untagged.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'eta_lep2_untagged.png'), format='PNG')
