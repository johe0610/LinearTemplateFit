...
# Analysis object: /WbWb_dilepton/DR_el_mu_presel
...
exec(open(prefix+'DR_el_mu_presel__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'DR_el_mu_presel.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'DR_el_mu_presel.png'), format='PNG')
