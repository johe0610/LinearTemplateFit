...
# Analysis object: /WbWb_dilepton/minimaxmbl_m_bbll
...
dataf = dict()
exec(open(os.path.split(__file__)[0] + '/minimaxmbl_m_bbll__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'minimaxmbl_m_bbll.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'minimaxmbl_m_bbll.png'), format='PNG')
