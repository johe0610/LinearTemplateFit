...
# Analysis object: /WbWb_dilepton/pT_bb4l
...
exec(open(prefix+'pT_bb4l__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'pT_bb4l.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'pT_bb4l.png'), format='PNG')
