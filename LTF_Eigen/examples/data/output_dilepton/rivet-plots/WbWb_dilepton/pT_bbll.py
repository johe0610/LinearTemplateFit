...
# Analysis object: /WbWb_dilepton/pT_bbll
...
exec(open(prefix+'pT_bbll__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'pT_bbll.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'pT_bbll.png'), format='PNG')
