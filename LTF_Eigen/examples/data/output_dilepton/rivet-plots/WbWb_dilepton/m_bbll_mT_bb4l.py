...
# Analysis object: /WbWb_dilepton/m_bbll_mT_bb4l
...
dataf = dict()
exec(open(os.path.split(__file__)[0] + '/m_bbll_mT_bb4l__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'm_bbll_mT_bb4l.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'm_bbll_mT_bb4l.png'), format='PNG')
