...
# Analysis object: /WbWb_dilepton/minimaxmbl_pT_lep1
...
dataf = dict()
exec(open(os.path.split(__file__)[0] + '/minimaxmbl_pT_lep1__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'minimaxmbl_pT_lep1.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'minimaxmbl_pT_lep1.png'), format='PNG')
