...
# Analysis object: /WbWb_dilepton/mu_e_presel
...
exec(open(prefix+'mu_e_presel__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'mu_e_presel.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'mu_e_presel.png'), format='PNG')
