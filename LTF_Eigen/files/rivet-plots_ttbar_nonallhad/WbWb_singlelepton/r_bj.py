...
# Analysis object: /WbWb_singlelepton/r_bj
...
exec(open(prefix+'r_bj__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'r_bj.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'r_bj.png'), format='PNG')
