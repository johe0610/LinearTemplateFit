...
# Analysis object: /WbWb_singlelepton/r_bq
...
exec(open(prefix+'r_bq__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'r_bq.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'r_bq.png'), format='PNG')
