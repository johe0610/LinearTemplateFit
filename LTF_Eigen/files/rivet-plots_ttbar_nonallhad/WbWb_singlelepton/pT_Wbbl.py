...
# Analysis object: /WbWb_singlelepton/pT_Wbbl
...
exec(open(prefix+'pT_Wbbl__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'pT_Wbbl.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'pT_Wbbl.png'), format='PNG')
