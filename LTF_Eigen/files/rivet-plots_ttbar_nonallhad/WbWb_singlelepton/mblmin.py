...
# Analysis object: /WbWb_singlelepton/mblmin
...
exec(open(prefix+'mblmin__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'mblmin.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'mblmin.png'), format='PNG')
