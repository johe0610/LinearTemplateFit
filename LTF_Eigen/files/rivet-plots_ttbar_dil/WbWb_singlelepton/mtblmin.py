...
# Analysis object: /WbWb_singlelepton/mtblmin
...
exec(open(prefix+'mtblmin__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'mtblmin.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'mtblmin.png'), format='PNG')
