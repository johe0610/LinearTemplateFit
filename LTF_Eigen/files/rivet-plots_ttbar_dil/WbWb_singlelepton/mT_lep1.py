...
# Analysis object: /WbWb_singlelepton/mT_lep1
...
exec(open(prefix+'mT_lep1__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'mT_lep1.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'mT_lep1.png'), format='PNG')
