...
# Analysis object: /WbWb_singlelepton/pT_Wbblnu
...
exec(open(prefix+'pT_Wbblnu__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'pT_Wbblnu.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'pT_Wbblnu.png'), format='PNG')
