...
# Analysis object: /WbWb_singlelepton/m_whad
...
ax_yScale = 'log'
xLims = (64.0, 96.0)
yLims = (0.0009000000000000001, 0.11000000000000001)
...
exec(open(prefix+'m_whad__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'm_whad.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'm_whad.png'), format='PNG')
