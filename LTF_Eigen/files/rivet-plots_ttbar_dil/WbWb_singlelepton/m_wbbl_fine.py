...
# Analysis object: /WbWb_singlelepton/m_wbbl_fine
...
exec(open(prefix+'m_wbbl_fine__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'm_wbbl_fine.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'm_wbbl_fine.png'), format='PNG')
